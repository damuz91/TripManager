...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { cellphone: @passenger.cellphone, name: @passenger.name, status: @passenger.status }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { cellphone: @passenger.cellphone, name: @passenger.name, status: @passenger.status }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
